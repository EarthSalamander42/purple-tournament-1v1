...
RUNE_SPAWN_TIME = 120.0					-- How long in seconds should we wait between rune spawns?
...
GAME_END_DELAY = 60.0					-- How long should we wait after the game winner is set to display the victory banner and End Screen?  Use -1 to keep the default (about 10 seconds)
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = {50, 200, 50}		--	Green
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = {200, 50, 50}		--	Red

USE_AUTOMATIC_PLAYERS_PER_TEAM = false   -- Should we set the number of players to 10 / MAX_NUMBER_OF_TEAMS?

CUSTOM_TEAM_PLAYER_COUNT = {}           -- If we're not automatically setting the number of players per team, use this table
CUSTOM_TEAM_PLAYER_COUNT[1] = 10 -- Spectator team
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_GOODGUYS] = 1
CUSTOM_TEAM_PLAYER_COUNT[DOTA_TEAM_BADGUYS]  = 1

-- Custom 1v1 settings
FREE_COURIER				= true
JUNGLE_DISABLED				= true
SHRINE_DISABLED				= true
SIDELANES_DISABLED			= true
TOWER_TIER_1_INVULNERABLE	= true
