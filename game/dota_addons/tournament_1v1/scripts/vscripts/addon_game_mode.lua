...
--[[
	...
	-- Load modifiers
	LinkLuaModifier("modifier_damage_immune", "modifiers/modifier_damage_immune.lua", LUA_MODIFIER_MOTION_NONE )
	LinkLuaModifier("modifier_jungle_blockers", "modifiers/modifier_jungle_blockers.lua", LUA_MODIFIER_MOTION_NONE )
